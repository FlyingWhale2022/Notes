...
🍒 一般来说，积分关系均基于预先计算或确定的**权重**和**横坐标**来构造，通常积分关系可以写成如下形式：

$$\sum_{i=1}^nw_if(x_i)\approx\int_{-1}^1f(x)\mathrm{d}x$$
...
中点公式和梯形公式的代数精度为 1 阶，Simpson 公式的代数精度为 3 阶。
